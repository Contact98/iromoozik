...
bot = Bot(
    api_token=os.environ.get("424195032:AAGtwKsqZxjoFyayE1bOI8q4P4ul6-yTwDU"),
    name=os.environ.get("iromoozik_bot"),
    botan_token=os.environ.get("424195032:AAGtwKsqZxjoFyayE1bOI8q4P4ul6-yTwDU")
)
